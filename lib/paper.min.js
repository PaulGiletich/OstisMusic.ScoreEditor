...
Na(eb());B.postfix&&!ab();)b=ka(a),b.operator=ha,b.prefix=!1,b.argument=a,cb(a),F(),a=D(b,"UpdateExpression");return a},Na=function(a,b){if(N(fileCtrl)){var c=ka(a);return c.object=a,c.property=ga(!0),c.computed=!1,Na(D(c,"MemberExpression"),b)}return N(vb)?(c=ka(a),c.object=a,c.property=V(),c.computed=!0,P(wb),Na(D(c,"MemberExpression"),b)):!b&&N(ca)?(c=ka(a),c.callee=a,c.arguments=Ob(ba,!1),Na(D(c,"CallExpression"),b)):a},eb=function(){switch(B){case Dc:var a=T();return F(),D(a,"ThisExpression");case ta:return ga();
