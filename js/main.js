...
var note6 = new OSTISMusic.Note('A', 5);
var note7 = new OSTISMusic.Note('B', 5);

var chord = new OSTISMusic.Chord(16, [note1, note4]);
...
var chord6 = new OSTISMusic.Chord(16, [note6, note2]);
var chord7 = new OSTISMusic.Chord(4, [note7, note3]);
var voice = new OSTISMusic.Voice([chord, chord2, chord3, chord4, chord5, chord6, chord7]);
